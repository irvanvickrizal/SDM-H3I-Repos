...
Partial Class USR_frmCODSubConList
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            If Session("User_Type") = Constants.User_Type_SubCon Then
                ddlUsertype.SelectedValue = Session("User_Type")
                ddlUsertype.Enabled = False
            ElseIf Session("User_Type") = Constants.User_Type_NSN Then
            ...
            If UCase(Request.QueryString("SelMode")) = "TRUE" Then
                ...
                ddlRole.SelectedValue = Constants.Subcon_SS_RoleID
