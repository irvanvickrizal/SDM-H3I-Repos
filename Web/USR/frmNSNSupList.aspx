<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmNSNSupList.aspx.vb" Inherits="USR_frmNSNSupList" %>
...
<body>
    ...
    <div style="width:100%" id="divWidth">
        <table cellpadding="1" border="0" cellspacing="1" width="100%">
            <tr>
                <td class="pageTitle" colspan="4" id="rowadd">User List</td>
            </tr>            
            <tr>
