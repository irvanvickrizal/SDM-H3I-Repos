<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmCustomer.aspx.vb" Inherits="frmCustomer" %>
...
<head id="Head1" runat="server">
  ...
  <link href="../CSS/Styles.css" rel="stylesheet" type="text/css" />
    ...
    <script language="javascript" type="text/javascript">
        ...
        {
            var msg = "";
            if (IsEmptyCheck(document.getElementById("txtCus_Name").value) == false)
            {
                msg = msg + "Name should not be Empty\n";
            }
            if (IsEmptyCheck(document.getElementById("txtCus_Addr").value) == false)
            {
        ...
        function modelCreate() {
            clearModalFields();
            $('#cusId').val("");
            $('#modalHeader').text("Create New Customer");
            $('#modalCreateUpdate').modal('show');
        }

        function modalEdit(name, address) {
            clearModalFields();
            $('#modalHeader').text("Customer Details");
            $('#txtCus_Name').val(name);
            $('#txtCus_Addr').val(address);
...
<body>
		        ...
		        <div class="box box-info">
			        ...
			        <div class="box-body">
				        <div class="table table-responsive">
					        <div class="col-md-7">
						        <div class="form-inline">
							        <div class="form-group">
                                        <label class="col-sm-5">Search Customer</label>
                                        <div class="col-sm-6">
                                            <asp:DropDownList ID="ddlSelect" runat="server" CssClass="form-control">
                                                <asp:ListItem Value="CUS_Name">Name</asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
							        </div>
                                    <div class="form-group">
                            ...
                            <asp:GridView ID="grdCustomer" runat="server" CellSpacing="0" CellPadding="1" AllowPaging="True"
                                ...
                                <Columns>
                                    ...
                                    <%--<asp:HyperLinkField ItemStyle-Width="15%" DataTextField="CUS_Name" DataNavigateUrlFields="CUS_Id"
                                        DataNavigateUrlFormatString="frmCustomer.aspx?id={0}&Mode=E" HeaderText="Name" SortExpression="CUS_Name" />--%>
                                    <asp:TemplateField HeaderText="Name" SortExpression="CUS_Name">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="CustName" runat="server" 
                                                Text='<%# Eval("CUS_Name") %>'
                                    ...
                                    <asp:BoundField DataField="CUS_Addr" HeaderText="Address" SortExpression="CUS_Addr" />
                                </Columns>
                            </asp:GridView>
				        </div>
			        </div>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <div class="form-group">
                                <label>Name</label>
                                <input type="text" id="txtCus_Name" runat="server" class="form-control" maxlength="30"
                            ...
                            <div class="form-group">
                                <label>Address</label>
                                <textarea id="txtCus_Addr" runat="server" rows="5" cols="50" class="form-control"></textarea>
                            </div>
                        </div>
                    </div>
  ...
  <%--<form id="form1" runat="server">
    <div>
      <table id="tblCustomer" runat="server" border="0" cellpadding="1" cellspacing="1"
        ...
        <tr>
          ...
          <td id="Td1" runat="server" class="lblText">
            <input type="text" id="txtCus_Name" runat="server" class="textFieldStyle" maxlength="30"
              style="text-transform: uppercase; width: 316px" onkeypress="javascript:return allowKeyAcceptsSingleDot('0123456789.ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz');" /></td>
        </tr>
        <tr>
          <td class="lblTitleM">
          ...
          <td style="width: 1%" valign="top">
            :</td>
          <td>
            <textarea id="txtCus_Addr" runat="server" rows="5" cols="50" class="textFieldStyle"></textarea>
          </td>
        </tr>
        <tr>
          <td colspan="2">
      ...
      <asp:GridView ID="grdCustomer" runat="server" CellSpacing="0" CellPadding="1" AllowPaging="True"
        ...
        <Columns>
          ...
          <asp:HyperLinkField ItemStyle-Width="15%" DataTextField="CUS_Name" DataNavigateUrlFields="CUS_Id"
            DataNavigateUrlFormatString="frmCustomer.aspx?id={0}&Mode=E" HeaderText="Name"
