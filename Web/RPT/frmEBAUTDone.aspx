<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmEBAUTDone.aspx.vb" Inherits="RPT_frmEBAUTDone" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>BAUT DONE</title>
    <style type="text/css">
        .HeaderReport {
        ...
        <div style="width: 100%">
            <div class="HeaderReport">
                <table width="100%">
                    <tr>
                        <td style="width: 85%">
                            <asp:Label ID="LblDocPanel" runat="server"></asp:Label>
                        </td>
            ...
            <div style="border-style: solid; border-width: 1px; border-color: Gray; margin-top: 10px;">
                <table cellpadding="1" cellspacing="2">
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TxtStartDate" runat="server" Height="14px" CssClass="GridOddRows"></asp:TextBox>
                        </td>
                        <td>
            ...
            <div style="margin-top: 10px; width: 100%;">
                <asp:Panel ID="PnlGetReport" runat="server" ScrollBars="Auto" Width="100%" BorderStyle="None">
                    <asp:UpdatePanel ID="upBAUTReport" runat="server">
                        <ContentTemplate>
                            <div>
                            ...
                            <asp:GridView ID="GvRFTReport" runat="server" AllowPaging="False" CellPadding="1"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="TSELPROJECTID" HeaderText="BTSType" />
                                    <asp:BoundField DataField="SubmitDate" HeaderText="Submit Date(NSN)" DataFormatString="{0:dd-MMM-yyyy}"
                                        HtmlEncode="false" NullDisplayText="-" />
                                    <asp:BoundField DataField="NSNApprover" HeaderText="PIC(NSN)" />
                                    <asp:BoundField DataField="ApprovedDate" HeaderText="Approved Date(H3I)" DataFormatString="{0:dd-MMM-yyyy}"
                                        HtmlEncode="false" />
                                    <asp:BoundField DataField="HCPTApprover" HeaderText="PIC(H3I)" />
