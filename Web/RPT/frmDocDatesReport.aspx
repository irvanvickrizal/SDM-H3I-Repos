<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmDocDatesReport.aspx.vb" Inherits="RPT_frmDocDatesReport" %>
...
<body>
    ...
    <table cellpadding="1" border="0" cellspacing="1" width="100%">
            ...
            <tr id="trPono" runat="Server">
                ...
                <td style="width:1%">:</td>
                <td><asp:DropDownList ID="ddlPO" runat="server" CssClass="selectFieldStyle"></asp:DropDownList></td>
                </tr>
       <tr id="trRpt" runat="Server">
        ...
        <tr id="trBack" runat="Server">
            ...
            <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="true" DisplayGroupTree="False" HasCrystalLogo="False" HasSearchButton="False" HasToggleGroupTreeButton="False" HasViewList="False" />
    </div>
    </form>
</body>
</html>
