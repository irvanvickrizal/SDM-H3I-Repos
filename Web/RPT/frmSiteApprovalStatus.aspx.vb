...
Imports System.Data
Imports System.IO
Partial Class frmSiteApprovalStatus
    ...
    End Sub
    Sub bindData()
        strsql = "exec HCPT_uspTrans_GetSiteApprovalStatus " & CommonSite.UserId
    ...
    Public Sub ExportToExcel()
        ...
        Dim strFilename As String = "2G_SiteApprovalStatus_" + DateTime.Now.ToShortDateString + ".xls"
    ...
    Private Sub BindSearchDataAdvanced(ByVal docid As Integer, ByVal usrtype As String, ByVal roleid As Integer)
        strsql = "exec HCPT_uspTrans_GetSiteApprovalStatus_advancedsearch " & CommonSite.UserId & ", " & docid & ", '" & usrtype & "', " & roleid
        dt = objutil.ExeQueryDT(strsql, "uspSiteApprovalStatus")
        grdDB.DataSource = dt
        grdDB.DataBind()
    End Sub
