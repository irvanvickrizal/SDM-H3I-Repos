<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmCACReport.aspx.vb" Inherits="RPT_frmCACReport" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
     <title>CAC REPORT</title>
    <style type="text/css">
        .HeaderReport
        {
        ...
        <div style="margin-top: 10px;">
            <asp:UpdatePanel ID="upATPReport" runat="server">
                <ContentTemplate>
                    ...
                    <asp:GridView ID="GvCACReport" runat="server" AllowPaging="False" EmptyDataText="No Data Record Found"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="NSNApprover" HeaderText="Nokia Approver" />
                            <asp:BoundField DataField="NSNApproveDate" HeaderText="Nokia Approve Date" HtmlEncode="false"
                                DataFormatString="{0:dd-MMM-yyyy HH:mm:ss}" ConvertEmptyStringToNull="true" />
                            <asp:BoundField DataField="MSReview" HeaderText="MS Approver" />
                            <asp:BoundField DataField="MSReviewDate" HeaderText="MS Approved Date" HtmlEncode="false"
                                DataFormatString="{0:dd-MMM-yyyy HH:mm:ss}" ConvertEmptyStringToNull="true" />
                            <asp:TemplateField>
                                <ItemTemplate>
