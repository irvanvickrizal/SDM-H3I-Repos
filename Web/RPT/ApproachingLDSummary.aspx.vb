...
Imports System.Data
Imports System.IO
Partial Class ApproachingLDSummary
    ...
    Sub bindData2()
        strsql = "exec uspApproachingLDSummary " & ddlRegion.SelectedValue
        dt = objutil.ExeQueryDT(strsql, "ApproachingLDSummary")
        grdDB.DataSource = dt
        'grdDB.PageSize = Session("Page_size")
        grdDB.DataBind()
        GridView2.DataSource = dt
        GridView2.DataBind()
        strsql = "exec uspApproachingLDSummaryTotal " & ddlRegion.SelectedValue
        dt = objutil.ExeQueryDT(strsql, "ApproachingLDSummary")
        grdDB2.DataSource = dt
        'grdDB2.PageSize = Session("Page_size")
        grdDB2.DataBind()
    End Sub
    ...
    Protected Sub grdDB_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdDB.RowDataBound
        Select Case e.Row.RowType
            Case DataControlRowType.DataRow
                ...
                lbl.Text = (grdDB2.PageIndex * grdDB2.PageSize) + (e.Row.RowIndex + 1) & ".&nbsp;"
        End Select
    End Sub

    Protected Sub grdDB2_PageIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewPageEventArgs) Handles grdDB2.PageIndexChanging
        grdDB2.PageIndex = e.NewPageIndex
        bindData()
    End Sub

    Protected Sub grdDB2_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdDB2.RowDataBound
        Select Case e.Row.RowType
            Case DataControlRowType.DataRow
                Dim lbl As Label = CType(e.Row.FindControl("lblNo"), Label)
                lbl.Text = (grdDB2.PageIndex * grdDB2.PageSize) + (e.Row.RowIndex + 1) & ".&nbsp;"
    ...
    Protected Sub GridView2_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView2.RowDataBound
        ...
        Select Case e.Row.RowType
            Case DataControlRowType.DataRow
                lbl = CType(e.Row.FindControl("lblNo"), Label)
