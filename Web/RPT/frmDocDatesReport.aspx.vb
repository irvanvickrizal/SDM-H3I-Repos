...
Partial Class RPT_frmDocDatesReport
    ...
    Protected Sub btnReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReport.Click
        ...
        cmd.CommandText = "Exec uspRPTDoc '" & ddlPO.SelectedItem.Text & "'"
        cmd.Connection = con
        ...
        Next
        Try
            rpt.Load(Server.MapPath("DocDatesReport.rpt"))
    ...
    Protected Sub btnBack_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBack.Click
        Session("rpt") = Nothing
        Response.Redirect("frmDocDatesReport.aspx")
    End Sub
