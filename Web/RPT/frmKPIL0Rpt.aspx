<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmKPIL0Rpt.aspx.vb" Inherits="RPT_frmKPIL0Rpt" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>KPI-L0 Done REPORT</title>
    <style type="text/css">
        .HeaderReport {
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="HeaderReport">
            <table width="100%">
                <tr>
                    <td style="width: 50%">KPI-L0 Done Report
                    </td>
                    <td style="width: 50%; text-align: right;">
                        <asp:Button ID="BtnExportExcel2" runat="server" Text="Export To Excel" CssClass="BtnExpt"
                            BackColor="#7f7f7f" />
                        <asp:Button ID="btnDashboard" runat="server" Text="Back to Dashboard" CssClass="BtnDefault" />
                    </td>
                </tr>
            </table>
        </div>
        <div style="border-style: solid; border-width: 1px; border-color: Gray; margin-top: 10px; text-align: center;">
            <table>
                <tr>
                    <td>
        ...
        <div style="margin-top: 10px;">
            <asp:UpdatePanel ID="upATPReport" runat="server">
                <ContentTemplate>
                    ...
                    <asp:GridView ID="gvDocReports" runat="server" AllowPaging="False" EmptyDataText="No Data Record Found"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Uploader" HeaderText="Initiator Name" />
                            ...
                            <asp:BoundField DataField="customerreviewername" HeaderText="Cust.Name" />
                            <asp:BoundField DataField="customerapprovedate" HeaderText="Cust.Approved Date" HtmlEncode="false"
                                DataFormatString="{0:dd-MMM-yyyy HH:mm:ss}" ConvertEmptyStringToNull="true" />
                            
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <a href='../PO/frmViewDocument.aspx?id=<%#Eval("SW_Id") %>' target="_blank" style="text-decoration: none; border-style: none;">
