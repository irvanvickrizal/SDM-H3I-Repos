...
Partial Class BAUT_frmTI_CAC
    ...
    Dim caccontrol As New CACController
#Region "NSNFramework"
...
#End Region
    ...
    Protected Sub btnGenerate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGenerate.Click
        ...
        If Request.Browser.Browser = "IE" Then
            ...
            If caccontrol.ODCAC_IU(info) = True Then
                Dim strQuerCountNotYetUploaded As String = "select count(*) from sitedoc where isuploaded = 0 and siteid =" & hdnsiteid.Value & " and version=" & hdnVersion.Value &
                ...
                If countNotYetUploaded = 0 Then
                    ...
                    ActivityLog_I(CommonSite.UserId, BaseConfiguration.Activity_Generate_Doc & " CAC")
...
#Region "custom methods"
    Private Sub BindData(ByVal wpid As String)
        Dim info As CACInfo = caccontrol.ODCAC_LD(wpid)
    ...
    Private Function CreatePDFFile(ByVal StrPath As String) As String
        ...
        Dim ReFileName As String
        filenameorg = hdnsiteno.Value & "-" & "CAC" & "-" & Format(CDate(DateTime.Now), "ddMMyyyyHHss")
