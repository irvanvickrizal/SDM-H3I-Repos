<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmTI_FAC.aspx.vb" Inherits="BAUT_frmTI_FAC" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function Showmain(type) {
			...
			if (type == "successandbacktofacreadycreation") {
                alert('Document Successfully Generated');
				window.location = '../HCPT_Dashboard/frmFACReadyCreation.aspx';
            }
    ...
    <form id="form1" runat="server">
        ...
        <div id="dvPrint" runat="server">
            <div class="headerform">
                <table cellpadding="0" cellspacing="0" width="97%" border="0">
                    <tr>
                        ...
                        <td colspan="4" align="center" class="lblBold" valign="top" style="width: 70%">FINAL ACCEPTANCE CERTIFICATE<br />
            ...
            <div class="siteATTPanel">
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr class="lblText">
                        <td>Type of Works</td>
                        <td>:</td>
                        <td>&nbsp;<asp:Label ID="LblTypeofWork" runat="server" CssClass="lblText"></asp:Label></td>
                    </tr>
                    <tr class="lblText">
                    ...
                    <tr class="lblText">
                        ...
                        <td>:</td>
                        <td>&nbsp;<asp:Label ID="LblContractorName" runat="server" CssClass="lblText"></asp:Label></td>
                    </tr>
                    <tr class="lblText">
                        <td>Site ID
                        </td>
            ...
            <div class="sitedescription">
                <div class="lblText">
                    The contractor hereby certifies that relevant parts of the Works referred to in
                    this Final Acceptance Certificate complies with the 2012 Network Expansion
                    Procurement dated 31 December 2012 (the <i><b>2012 NEPA</b></i>), in particular
                    the specification and this has successfully passed the Acceptance Criteria(as defined
                    in Annex E of 2012 NEPA) on the Site with the following remarks:
                </div>
            </div>
            <div class="pnlremarks">
                <table>
                    <tr class="lblText" valign="top">
                        ...
                        <td>Punch List cleared and no outstanding Documentation
                        </td>
                    </tr>
                    <tr class="lblText" valign="top">
                        <td>
            ...
            <div class="pnlNote">
                ...
                <ul>
                    <li><span class="lblTextItalic">The Punch List shall be cleared within the time period(s) stipulated in the punch
                        list</span></li>
        ...
        <div id="documentPanel" style="margin-top: 15px;">
            <table width="100%">
                ...
                <tr class="lblText">
                    <td align="center">
						<asp:Label ID="lblGenerateTest" runat="server"></asp:Label>
