...
Partial Class frmTI_BOQ_1
    ...
    Sub tableHeader(ByRef submit As Boolean)
        ...
        dt = objutil.ExeQueryDT(strsql, "odboqtablenew")
    ...
    Sub uploaddocument(ByVal vers As Integer, ByVal keyval As Integer)
        ...
        If (hdfAdditionalInformation.Value.Equals("true")) Then
            SaveModernizationValue()
        End If
    ...
    Sub CreateXY()
        ...
        For IncrMentX As Integer = 0 To dvnotin2.Count - 1
            ...
            'objdo.YVal = 535 - (dt.Rows.Count * 15)
            objdo.YVal = 325
            '--
