...
Partial Class BAUT_frmTI_RFT
    ...
    Dim rftcontrol As New RFTController
...
#End Region
    ...
    Protected Sub btnGenerate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGenerate.Click
        ...
        If Request.Browser.Browser = "IE" Then
            ...
            If rftcontrol.ODRFT_IU(info) = True Then
                ...
                If countNotYetUploaded = 0 Then
                    ...
                    ActivityLog_I(CommonSite.UserId, BaseConfiguration.Activity_Generate_Doc & " RFT")
...
#Region "Custom Methods"
    Private Sub BindData(ByVal wpid As String)
        Dim info As RFTInfo = rftcontrol.ODRFT_LD(wpid)
    ...
    Private Sub GetSiteAttribute(ByVal wpid As String)
        ...
        If info IsNot Nothing Then
            ...
            LblContractorName.Text = "Nokia Solutions and Networks"
    ...
    Private Function CreatePDFFile(ByVal StrPath As String) As String
        ...
        Dim ReFileName As String
        filenameorg = hdnsiteno.Value & "-" & "RFT" & "-" & Format(CDate(DateTime.Now), "ddMMyyyyHHss")
        ReFileName = filenameorg & ".htm"
        Dim strPathnew As String = hdnsiteno.Value & "\TI\" & hdnScope.Value & "-" & GetWPID() & "\" & ReFileName
    ...
    Private Sub uploaddocument(ByVal vers As Integer, ByVal keyval As Integer)
        ...
        If strResult = "0" Then
            DocPath = lblSiteID.Text & ft & CreatePDFFile(Replace(path, "  \", "\"))
        ...
        Else
            Response.Redirect("../HCPT_Dashboard/frmRFTReadyCreation.aspx")
        End If
