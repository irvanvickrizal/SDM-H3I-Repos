<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmTI_PAC.aspx.vb" Inherits="BAUT_frmTI_PAC" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function Showmain(type) {
            ...
            if (type == 'nyreg') {
                alert('This PAC NY Registered in Document on Parallel CAC');
            }
        ...
        <div id="dvPrint" runat="server">
            ...
            <div class="sitedescription">
                <div class="lblText">
                    ...
                    this Provisional Acceptance Certificate complies with the 2012 Network Expansion
