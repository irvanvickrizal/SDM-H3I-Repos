<%@ Page Language="VB" AutoEventWireup="true" CodeFile="frmTI_RFT.aspx.vb" Inherits="BAUT_frmTI_RFT"
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function Showmain(type) {
            ...
            if (type == 'nyreg') {
                alert('This RFT NY Registered in Document on Parallel BAUT');
            }
        ...
        <div id="dvPrint" runat="server">
                ...
                <table cellpadding="0" cellspacing="0" width="100%" border="0">
                    <tr>
                        <td align="left" valign="top" style="width: 15%">
                            <img src="http://localhost:2017/Images/nsn-logo.gif" height="46px" width="104px"
                                alt="nsnLogo" />
                        </td>
                        <td colspan="4" align="center" class="lblBold" valign="top" style="width: 70%">
                            READY FOR TRIAL CERTIFICATE<br />
                            <asp:Label ID="LblRFTNo" runat="server" CssClass="lblRef"></asp:Label>
                        </td>
                        <td align="right" valign="top" style="width: 15%">
                            <img src="http://hcptdemo.nsnebast.com:2017/Images/three-logo.png" height="46px" width="60px"
                                alt="hcptlogo" />
                        </td>
                    </tr>
                </table>
            ...
            <div class="sitedescription">
                <div class="lblText">
                    ...
                    this Ready For Trial (RFT) Certificate complies with the 2012 Network Expansion
                ...
                <table>
                    ...
                    <tr class="lblText" valign="top">
                        ...
                        <td>
                            ...
                            been classified in accordance with Annex E (Acceptance) of the 2012 NEPA"
                        </td>
                    </tr>
                </table>
                <hr />
            ...
            <div class="pnlNote">
                ...
                <ul>
                    <li><span class="lblTextItalic">The Punch List shall be cleared within the time period(s) stipulated in the punch
                        list</span></li>
                    <li><span class="lblTextItalic">RFT Acceptance Punch List attached</span></li>
                </ul>
            </div>
