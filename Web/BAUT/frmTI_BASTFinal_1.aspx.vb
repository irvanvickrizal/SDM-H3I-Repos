...
Partial Class BAUT_frmTI_BASTFinal_1
...
#Region "custom methods"
    Sub tableHeader(ByRef submit As Boolean)
        ...
        For i = 1 To (iCount + 1)
            ...
            If Session("rdoBAST2") = True Then
                textcss1 = "border-style:solid;border-color:white;border-width:1px;background-color:skyblue;text-align:center;font-size:6pt;"
                textcss2 = "border-style:solid;border-color:white;border-width:1px;background-color:skyblue;width:70px;text-align:center;font-size:6pt;"
                textcss1a = "border-style:solid;border-color:white;border-width:1px;background-color:white;text-align:center;width:70px;font-size:6pt;"
                textcss2a = "border-style:solid;border-color:white;border-width:1px;background-color:white;width:70px;text-align:center;font-size:6pt;"
            Else
                textcss1 = "border-style:solid;border-color:white;border-width:1px;background-color:skyblue;text-align:center;"
                textcss2 = "border-style:solid;border-color:white;border-width:1px;background-color:skyblue;width:100px;text-align:center;"
                textcss1a = "border-style:solid;border-color:white;border-width:1px;background-color:white;text-align:center;"
                textcss2a = "border-style:solid;border-color:white;border-width:1px;background-color:white;width:100px;text-align:center;"
            End If
            ...
            Dim textcssusd As String = "border-style:solid;border-color:white;border-width:1px;background-color:white;text-align:center;font-size:6pt; width:60px;"
            ...
            If dt.Rows.Count > 0 Then
                ...
                Else
                    iMaincell_BastValRowUSD.InnerHtml = inhtml.Replace("@id", "input" & i & "m").Replace("@txt", inhtml_BSTValUSD).Replace("@sty", textcssB)
                End If
            ...
            Else
                ...
                Else
                    iMianCell22.InnerHtml = inhtmlmain.Replace("@id", "input" & i & "b").Replace("@txt", "")
                End If
        ...
        Dim textcsstotalUSD As String = "border-style:solid;border-color:white;border-width:1px;background-color:white;width:60px;text-align:center;font-size:6.5pt;font-weight:bold;"
    ...
    Function CreatePDFFile(ByVal StrPath As String) As String
        ...
        sw.WriteLine(".MainCSS{margin-bottom: 0px;margin-left: 20px;margin-right: 20px;margin-top: 0px;width: 800px;height: 780px;text-align: center;}")
    ...
    Sub CreateXY()
        ...
        For IncrMentX As Integer = 0 To dvnotin2.Count - 1
            ...
            'Permanent position
            objdo.YVal = 150 - (dt.Rows.Count * 15)
            '--
...
#End Region
    ...
    Protected Sub txtBastRefNo_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtBastRefNo.TextChanged
