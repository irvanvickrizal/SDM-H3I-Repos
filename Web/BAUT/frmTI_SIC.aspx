<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmTI_SIC.aspx.vb" Inherits="BAUT_frmTI_SIC" EnableEventValidation="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>SITE INTEGRATION CERTIFICATE</title>
    ...
    <script language="javascript" type="text/javascript">
            ...
            function transferValue(rw){
                ...
                for (var i = 1; i <= rw; i++) {
                    ...
                    var valK = valE - valH;
                    if (i == 1) {
                        csv = valA + "!" + valB + "!" + "0!" + valD + "!" + valE + "!" + "0!" + valG + "!" + valH + "!" + "0!" + valJ + "!" + valK;
                    }
                    else {
                        csv += "@" + valA + "!" + valB + "!" + "0!" + valD + "!" + valE + "!" + "0!" + valG + "!" + valH + "!" + "0!" + valJ + "!" + valK;
                    }
                                    ...
                                    <table cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            ...
                                            <td colspan="4" align="center" class="lblBold" valign="top" style="width: 60%">
                                                <asp:Label ID="LblHeaderBAST" runat="server" Text="SITE INTEGRATION CERTIFICATE"
                                    ...
                                    <table cellpadding="0" cellspacing="0" width="100%">
                                        ...
                                        <tr class="lblText">
                                            <td align="center" colspan="3">
                                                Number :
                                                <asp:TextBox ID="txtSicRefNo" runat="server" CssClass="textFieldStyle" Width="650px">
                                                </asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr class="lblText">
                                        ...
                                        <tr class="lblText">
                                            <td colspan="3">
                                                On the date&nbsp;<input type="text" id="txtDate" runat="server" class="textFieldStyle"
                                                    readonly="readonly"><asp:ImageButton ID="btnDate" runat="server" Height="16px" ImageUrl="~/Images/calendar_icon.jpg"
                                                        Width="18px" /><b>
