<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmWorkflowSiteBaseGRP.aspx.vb"
    Inherits="Admin_frmWorkflowSiteBaseGRP" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Workflow grouping for Task Pending Base on SiteBase</title>
...
<body>
	                ...
	                <div class="col-xs-12">
		                <div class="box box-info">
			                <div class="box-header with-border">
				                <h3 class="box-title">Workflow Grouping For Task Pending Site Base Configuration</h3>
			                </div>
			                <div class="box-body">
				                <div class="table table-responsive">
					                <asp:GridView ID="GvWFSiteBaseGroup" runat="server" AutoGenerateColumns="false" EmptyDataText="No Record Found" AllowPaging="true" PageSize="5"
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="ImgDelete" runat="server" ImageUrl="~/images/gridview/Cancel.jpg"
                                                        Width="20px" Height="20px" CommandArgument='<%#Eval("SNO") %>' CommandName="deletewf"
                                                        OnClientClick="return confirm('Are you sure you want to delete this workflow');" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
		                ...
		                <div class="box box-info">
			                ...
			                <div class="box-body">
				                <div class="table table-responsive">
					                ...
					                <div class="col-md-6">
							            <asp:GridView ID="GvWorkflows" runat="server" AutoGenerateColumns="false" EmptyDataText="No Record Found"
                                                ...
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="ImgAdd" runat="server" ImageUrl="~/images/gridview/AddNewItem.jpg"
                                                            Width="20px" Height="20px" CommandArgument='<%#Eval("WFID") %>' CommandName="addwf"
    ...
    <div id="HeaderPanel">
        Workflow Grouping For Task Pending Site Base Configuration
    </div>
    <asp:UpdateProgress ID="upgATPReport" runat="server" DisplayAfter="0">
        <ProgressTemplate>
            <div id="blur">
    ...
    <asp:UpdatePanel ID="UP1" runat="server">
        <ContentTemplate>
            <div style="margin-top: 10px;">
                <asp:GridView ID="GvWFSiteBaseGroup" runat="server" AutoGenerateColumns="false" EmptyDataText="No Record Found" Width="99%">
                    <HeaderStyle CssClass="gridHeader_2" />
                    <RowStyle CssClass="gridOdd" />
                    <AlternatingRowStyle CssClass="gridEven" />
                    <Columns>
                        <asp:BoundField DataField="WFName" HeaderText="Workflow" />
                        <asp:BoundField DataField="LMDT" HeaderText="Last modified date" HtmlEncode="false"
                            DataFormatString="{0:dd-MMM-yyyy HH:mm:ss}" ConvertEmptyStringToNull="true" />
                        <asp:BoundField DataField="ModifiedUser" HeaderText="Last Modified User" />
                        <asp:TemplateField>
