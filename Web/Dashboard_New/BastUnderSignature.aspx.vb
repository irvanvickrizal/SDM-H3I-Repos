...
Partial Class Dashboard_New_BastUnderSignature
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack = False Then
            BindData()
            LblHeaderBastUnderSignature.Text = "BAST Under Tsel Signature"
            Select Case Request.QueryString("id")
                Case 2
                    LblHeaderBastUnderSignature.Text = "BAST Under NSN Signature"
