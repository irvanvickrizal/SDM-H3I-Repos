...
Partial Class DashBoard_frmDashboardNPO_Subcon
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            BindDocReadyCreation(CommonSite.UserId, ConfigurationManager.AppSettings("SSVL2DOCID"), lblKPIL2RCCount)    'Added by Fauzan, 3 Dec 2018. Bind KPI L2 Document
