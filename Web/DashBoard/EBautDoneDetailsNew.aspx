<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EBautDoneDetailsNew.aspx.vb" Inherits="DashBoard_frmEbautDoneDetailsNew" %>
...
<body>
    ...
    <div>
        <table width="100%" cellspacing="1" cellpadding="1">
            ...
            <tr>
                 <td colspan="5" Class="pageTitle">BAUT Status
            </tr>
            <tr>
                <td colspan="5">
                    <asp:GridView ID="grdDB" runat="server" AutoGenerateColumns="False" Width="100%"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Date_time" HeaderText="BAUT Date(Telkomsel)" />
