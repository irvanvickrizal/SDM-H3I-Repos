<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DashboardpopupBaut.aspx.vb"
    Inherits="DashboardpopupBaut" EnableEventValidation="false" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                ...
                <tr>
                    <td align="right">
                        <input id="BtnClose" type="submit" value="Close" runat="server" />
                    </td>
                </tr>
            </table>
        </div>
