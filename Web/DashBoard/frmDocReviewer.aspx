<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmDocReviewer.aspx.vb"
    Inherits="frmDocReviewer" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Document Reviewal</title>
    ...
    <script language="javascript" type="text/javascript">
            ...
            function Reject(id){
                ...
                window.open('RejectReview.aspx?tskid=' + tskid + '&id=' + id, 'welcome2', 'width=550,height=200,resizable=yes,menubar=no,status=no,location=no,toolbar=no,scrollbars=yes');
            }
            ...
            function Approve(id, docname, siteno, version, pono, swid){
                ...
                if (docname == 'BAUT') {
                    ...
                    window.open('../digital-sign/Digital-signature.aspx?tskid=' + tskid + '&id=' + id + '&docname=' + docname + '&version=' + version + '&siteno=' + siteno + '&pono=' + pono + '&swid=' + swid + '&time=' + (new Date()).getTime(), 'welcome3', 'width=850,height=700,menubar=no,resizable=yes,status=no,location=no,toolbar=no,scrollbars=yes');
                }
            }
                    ...
                    <td colspan="4">
                        <asp:GridView ID="grdDocuments" runat="server" AllowPaging="False" EmptyDataText="All documents approved"
                            ...
                            <Columns>
                                ...
                                <asp:ButtonField CommandName="Delete" Text="Approve" ValidationGroup="grdValid" HeaderText="Approve"
