<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmDashBoardDetails.aspx.vb"
    Inherits="DashBoard_frmDashBoardDetails" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>PO Site List</title>
                ...
                <td colspan="5">
                    <asp:GridView ID="grdDB" runat="server" AutoGenerateColumns="False" Width="100%"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="completed" DataFormatString="{0:dd-MMM-yyyy}" HeaderText="Completed Date" />
                            <asp:BoundField DataField="bastdone" DataFormatString="{0:dd-MMM-yyyy}" HeaderText="BAST Date" />
                        </Columns>
                    </asp:GridView>
                </td>
            </tr>
