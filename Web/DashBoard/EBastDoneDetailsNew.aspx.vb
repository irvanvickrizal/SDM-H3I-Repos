...
Imports System.Data
Imports System.IO
Partial Class DashBoard_frmEbastDoneDetailsNew
    ...
    Sub bindData()
        ...
        Select Case Request.QueryString("ID")
            Case 1
                strsql = "exec uspBASTDONEsitestatusdetails " & Session("User_Id") & ", '" & Session("lvlcode") & "','" & ConfigurationManager.AppSettings("BASTID") & "'"
            Case 2
                strsql = "exec uspBASTUTsitestatusdetails " & Session("User_Id") & ", '" & Session("lvlcode") & "','" & ConfigurationManager.AppSettings("BASTID") & "'"
            Case 3
                strsql = "exec uspBASTUCsitestatusdetails " & Session("User_Id") & ", '" & Session("lvlcode") & "','" & ConfigurationManager.AppSettings("BASTID") & "'"
            Case 5
                strsql = "exec uspBASTPRsitestatusdetails " & Session("User_Id") & ", '" & Session("lvlcode") & "','" & ConfigurationManager.AppSettings("BASTID") & "'"
        End Select
    ...
    Protected Sub btnfullinfo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnfullinfo.Click
        Response.Redirect("B4BASTFullinfo.aspx?id=" & Request.QueryString("Id") & "")
    End Sub
End Class
