<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ATPOnSiteScheduled.aspx.vb" Inherits="DashBoard_ATPOnSiteScheduled" %>
...
<head runat="server">
    ...
    <title>ATP ON SITE SCHEDULED</title>
    <style type="text/css">
        .PnlHeader
        {
            Padding:3px;
    ...
    <div style="width:99%">
        <div id="PnlATPOnSite" style="margin-top:20px;">
            <div id="ATPOnSiteHeader" class="PnlHeader2">
                ATP On-Site Scheduled
            </div>
            <div id="ATPOnSiteDocument" style="margin-top:10px;margin-left:1px;">
                <asp:GridView ID="gvDocCountATPOnSite" runat="server" AllowPaging="False" EmptyDataText="No Scheduled"
            ...
            <div style="text-align:right; margin-top:10px;">
                <asp:Button ID="BtnViewAll" runat="server" Text="View All" CssClass="buttonStyle" />
            </div>
        </div>
    </div>
    </form>
