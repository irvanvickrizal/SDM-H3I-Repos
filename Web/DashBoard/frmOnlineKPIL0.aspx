<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmOnlineKPIL0.aspx.vb" Inherits="DashBoard_frmOnlineKPIL0" EnableEventValidation="false" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function Showmain(type, docid = 0) {
            ...
            //window.location = 'frmKPIL0RC.aspx.aspx'  Original
            window.location = "frmKPIL0RC.aspx?id=" + docid + " "    //Modified by Fauzan, 7 Nov 2018. Remove double .aspx. 2 Dec. Add paramater
        }
