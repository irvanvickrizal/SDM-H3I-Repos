<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EBastDoneDetailsNew_fullinfo.aspx.vb" Inherits="DashBoard_EBastDoneDetailsNew_fullinfo" %>
    ...
    <form id="form1" runat="server">
     <div>
        <table width="100%" cellspacing="1" cellpadding="1">
            ...
            <tr>
                <td colspan="5" Class="pageTitle">BAST Status Full Info
                </td>
            </tr>
            <tr>
                <td colspan="5">
                    <asp:GridView ID="grdDB" runat="server" AutoGenerateColumns="False" Width="100%"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="BAUT_CDate" HeaderText="BAUT_TelomselDate" />
                            <asp:BoundField DataField="BAUT_TUSER" HeaderText="BAUT_TelomselUSER" />
                            <asp:BoundField DataField="BAUT_TDate" HeaderText="BAUT_TelomselDate" />
                            <asp:BoundField DataField="BAST_CUSER" HeaderText="BAST_NSNUSER" />
                            <asp:BoundField DataField="BAST_CDate" HeaderText="BAST_NSNDate" />
                            <asp:BoundField DataField="BAST_TUser" HeaderText="BAST_TelomselUser" />
                            <asp:BoundField DataField="BAST_TDate" HeaderText="BAST_TelomselDate" />
                        </Columns>
                    </asp:GridView>
                </td>
            </tr>
