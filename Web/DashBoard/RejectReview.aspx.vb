...
Partial Class RejectReview
    ...
    Protected Sub BtnSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnSubmit.Click
        ...
        Else
            ...
            Dim i As Integer = -1
            'dedy 091106
            i = objBo.uspDocReject(Convert.ToInt32(GrpId), CommonSite.UserId(), CommonSite.UserName(), CommonSite.RollId(), (txtRemarks.Text).Replace("'", " ").ToString, ConfigurationManager.AppSettings("BAUTID"), ConfigurationManager.AppSettings("BASTID"), ConfigurationManager.AppSettings("WCTRBASTID"))
            If i = 0 Then
