...
Partial Class DashBoard_frmDashBoardDetails
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Page.IsPostBack = False Then
            ...
            bindData(Request.QueryString("P").ToString)
        End If
    End Sub
    Sub bindData(ByVal strRegion As String)
        Dim strsql As String = "Exec [uspDashboardDetailsnew] '" & strRegion & "'," & Request.QueryString("id") & "," & CommonSite.GetDashBoardLevel() & "," & CommonSite.UserId()
