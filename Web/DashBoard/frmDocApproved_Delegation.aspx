<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmDocApproved_Delegation.aspx.vb"
    Inherits="DashBoard_frmDocApproved_Delegation" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
            ...
            function Approve(id, docname, siteno, version, pono, swid){
                ...
                window.open('../digital-sign/Digital-signature-delegation.aspx?tskid=' + tskid + '&id=' + id + '&docname=' + docname + '&version=' + version + '&siteno=' + siteno + '&pono=' + pono + '&swid=' + swid + '&wpid=' + wpid + '&uid=' + uid + '&time=' + (new Date()).getTime(), 'welcome3', 'width=850,height=700,menubar=no,resizable=yes,status=no,location=no,toolbar=no,scrollbars=yes');
            }
