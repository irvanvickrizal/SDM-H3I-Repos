...
Imports System.Data
Imports System.IO
Partial Class DashBoard_frmEbautDoneDetailsNew_fullinfo
    ...
    Sub bindData()
        ...
        Select Case Request.QueryString("ID")
            Case 1
                strsql = "exec uspBAUTDONEsitestatusdetails_fullinfo " & Session("User_Id") & ", '" & Session("lvlcode") & "','" & ConfigurationManager.AppSettings("BAUTID") & "'"
            Case 2
                strsql = "exec uspBAUTUTsitestatusdetails_fullinfo " & Session("User_Id") & ", '" & Session("lvlcode") & "','" & ConfigurationManager.AppSettings("BAUTID") & "'"
            Case 3
                strsql = "exec uspBAUTUCsitestatusdetails_fullinfo " & Session("User_Id") & ", '" & Session("lvlcode") & "','" & ConfigurationManager.AppSettings("BAUTID") & "'"
            End Select
