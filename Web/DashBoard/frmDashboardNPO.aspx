<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmDashboardNPO.aspx.vb" Inherits="DashBoard_frmDashboardAgendaNPO" %>
            ...
            <div class="col-md-8">
                <div class="box box-default">
                    <div class="box-header with-border">
                            ...
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-text">
                                        <span style="font-size:40px"><asp:Literal ID="ltrTaskPendingCount" runat="server"></asp:Literal></span>
                                    </span>
                                </div>
                                <!-- /.info-box-content -->
                            </div>
                        ...
                        <div class="row">
                            <%--Added by Fauzan 30 Nov 2018. SSV L2 & KPI L2--%>
                            <div class="col-md-4">
                                <div class="small-box bg-red">
                                    <div class="inner">
                                        <h3>
