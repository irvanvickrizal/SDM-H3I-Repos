<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DashboardpopupWCTRBast.aspx.vb" Inherits="DashboardpopupWCTRBast" EnableEventValidation = "false"%>
...
function Approve(id,siteno,version)
{
     ...
     window.open('../BAUT/frmTI_WCTRBAST.aspx?id='+id+'&open=1&from=wctr' ,'welcome5','width=850,height=700,menubar=no,resizable=yes,status=no,location=no,toolbar=no,scrollbars=yes');
         ...
         <tr>
            ...
            <tr>
                <td id="Td1" runat="server">
                       <asp:GridView ID="grdDocuments" runat="server" AllowPaging="True" EmptyDataText="All documents approved" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="siteno">
