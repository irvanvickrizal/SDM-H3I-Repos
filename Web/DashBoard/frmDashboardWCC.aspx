<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmDashboardWCC.aspx.vb"
    Inherits="DashBoard_frmDashboardWCC" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Agenda WCC Dashboard</title>
    <style type="text/css">
        #box
    {
		border-style: solid;
...
color-stop(0%, white), color-stop(15%, white), color-stop(100%, #f3f3f3));
        background: -moz-linear-gradient(top, white 0%, white 55%, #f3f3f3 130%);
        margin: 0px auto;
                                    ...
                                    <table width="100%">
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                ...
                                                <a href="../fancybox_form/fb_WCCDone.aspx">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="LblWCCTaskPending" runat="server" Text="Your Task Pending (0)" CssClass="lblText"></asp:Label>
                                                <asp:LinkButton ID="LbtWCCTaskPending" runat="server" CssClass="lblText"></asp:LinkButton>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <a href="../fancybox_form/fb_WCCOnTaskPending.aspx" class="fancyboxViewDashboard fancybox.iframe">
                                            ...
                                            <td>
                                                <asp:Label ID="LblWCCReadyCreationNull" runat="server" Text="WCC Ready Creation(0)"
                                                    CssClass="lblTaskPending"></asp:Label>
                                                <a href="../fancybox_form/fb_WCCReadyCreation.aspx" class="fancyboxViewDashboard fancybox.iframe">
                                                    <asp:Label ID="LblWCCReadyCreation" runat="server" CssClass="lblText"></asp:Label></a>
                                            </td>
                                            <td>
                                                <img src="../images/arrow_left.png" alt="leftarrow" height="30" width="25" />
                                            </td>
                                            ...
                                            <td>
                                                <asp:Label ID="LblSiteNeedWCCNull" runat="server" Text="WCC Preparation(0)" CssClass="lblText"></asp:Label>
                                                <a href="../fancybox_form/fb_WCCPreparation.aspx" class="fancyboxViewDashboard fancybox.iframe">
                                                    <asp:Label ID="LblWCCPreparation" runat="server" CssClass="lblText"></asp:Label></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="11">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="4">
                                                ...
                                                <a href="../fancybox_form/fb_WCCRejection.aspx" class="fancyboxViewDashboard fancybox.iframe">
                                                    <asp:Label ID="LblWCCRejection" runat="server" CssClass="lblText"></asp:Label></a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <tr valign="top">
                                    ...
                                    <td>
                                        <a class="popup" href="../RPT/frmEBASTDone.aspx" title="BAST DONE"><span style="font-family: Verdana;
                                            font-size: 12px;">BAST Done Report</span></a>
                                    </td>
                                    <td>
                                        <img src="../images/green_checkmark20.jpg" alt="RptIcon" height="15" />
                                    </td>
                                    ...
                                    <td>
                                        <a class="popup" title="QC DONE" href="../Rpt/frmQCReport.aspx"><span style="font-family: Verdana;
