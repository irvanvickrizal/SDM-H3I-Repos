...
Public Class CACController
    ...
    Public Function ODCAC_IU(ByVal info As CACInfo) As Boolean
        Dim isSucceed As Boolean = True
        Dim strErrMessage As String = String.Empty
        Command = New SqlCommand("HCPT_uspCAC_IU", Connection)
        ...
        If isSucceed = False Then
            ErrorLogInsert(150, "ODCAC_IU", strErrMessage, "HCPT_uspCAC_IU")
        End If

        Return isSucceed
    End Function

    Public Function ODCAC_LD(ByVal wpid As String) As CACInfo
        Dim info As New CACInfo
        Dim strErrMessage As String = String.Empty
        Command = New SqlCommand("HCPT_uspCAC_LD", Connection)
        Command.CommandType = CommandType.StoredProcedure
        ...
        Try
            ...
            If DataReader.HasRows Then
                While DataReader.Read
                    ...
                    info.CACID = Convert.ToInt32(DataReader.Item("CAC_ID"))
        ...
        If Not String.IsNullOrEmpty(strErrMessage) Then
            ErrorLogInsert(150, "ODCAC_LD", strErrMessage, "HCPT_uspCAC_LD")
        End If
