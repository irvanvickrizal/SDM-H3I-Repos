...
Public Class FACController
    ...
    Public Function ODFAC_IU(ByVal info As FACInfo) As Boolean
        Dim isSucceed As Boolean = True
        Dim strErrMessage As String = String.Empty
        Command = New SqlCommand("HCPT_uspFAC_IU", Connection)
        ...
        If isSucceed = False Then
            ErrorLogInsert(150, "ODFAC_IU", strErrMessage, "HCPT_uspFAC_IU")
        End If

        Return isSucceed
    End Function

    Public Function ODFAC_LD(ByVal wpid As String) As FACInfo
        Dim info As New FACInfo
        Dim strErrMessage As String = String.Empty
        Command = New SqlCommand("HCPT_uspFAC_LD", Connection)
        Command.CommandType = CommandType.StoredProcedure
        ...
        Try
            ...
            If DataReader.HasRows Then
                While DataReader.Read
                    ...
                    info.FACID = Convert.ToInt32(DataReader.Item("FAC_ID"))
        ...
        If Not String.IsNullOrEmpty(strErrMessage) Then
            ErrorLogInsert(150, "ODFAC_LD", strErrMessage, "HCPT_uspFAC_LD")
        End If
