...
Partial Class frmDashboard
    ...
    Sub CreateSiteStatus()
        ...
        Dim dtStatusBAUT As New DataTable
        Dim dtra As New DataTable
        Dim dtr As New DataTable
        Dim dta As New DataTable
        Dim mycase As String = ""
        Dim rgn As String = ""
        dtStatus = objUtil.ExeQueryDT("exec uspBASTsitestatuscount " & Session("User_Id") & ", '" & Session("lvlcode") & "','" & ConfigurationManager.AppSettings("BASTID") & "'", "BASTSTATUS")
        ...
        If dtStatus.Rows.Count > 1 Then
            For intCount As Integer = 0 To dtStatus.Rows.Count - 1
                ...
                Else
                    If dtStatus.Rows(intCount)("nodays") Is DBNull.Value Then
                        strBind = "<div class=""hgap""><a href=# onclick=popSitesDetails(" + dtStatus.Rows(intCount)("sno").ToString + ")> " & dtStatus.Rows(intCount)("Process").ToString & "  </a></div>"
            ...
            Next
        End If
        dtStatusBAUT = objUtil.ExeQueryDT("exec uspBAUTsitestatuscount " & Session("User_Id") & ", '" & Session("lvlcode") & "','" & ConfigurationManager.AppSettings("BAUTID") & "'", "BASTSTATUS")
        If dtStatusBAUT.Rows.Count > 0 Then

            For intCount As Integer = 0 To dtStatusBAUT.Rows.Count - 1
                If (dtStatusBAUT.Rows(intCount)("ECount") = 0) Then
                    strBind = "<div class=""hgap"">" & dtStatusBAUT.Rows(intCount)("Process").ToString & " </div>"
                    strBindNo = "<div class=""hgap"">( " & dtStatusBAUT.Rows(intCount)("ECount").ToString & " )</div>"
                    strBinddays = "<div class=""hgap"">" & dtStatusBAUT.Rows(intCount)("nodays").ToString & "</div>"
                Else
                    If dtStatusBAUT.Rows(intCount)("nodays") Is DBNull.Value Then
                        strBind = "<div class=""hgap""><a href=# onclick=popSitesDetailsBAUT(" + dtStatusBAUT.Rows(intCount)("sno").ToString + ")> " & dtStatusBAUT.Rows(intCount)("Process").ToString & "  </a></div>"
                        strBindNo = "<div class=""hgap"">( " & dtStatusBAUT.Rows(intCount)("ECount").ToString & " )"
                        strBinddays = "<div class=""hgap"">" & dtStatusBAUT.Rows(intCount)("nodays").ToString & "</div>"
                    Else
                        strBind = "<div class=""hgap""><a href=# onclick=popSitesDetailsBAUT(" + dtStatusBAUT.Rows(intCount)("sno").ToString + ")> " & dtStatusBAUT.Rows(intCount)("Process").ToString & "  </a></div>"
                        strBindNo = "<div class=""hgap"">( " & dtStatusBAUT.Rows(intCount)("ECount").ToString & " )"
                        strBinddays = dtStatusBAUT.Rows(intCount)("nodays").ToString & " Days"
                    End If
                End If
                Select Case intCount
                    Case 0
