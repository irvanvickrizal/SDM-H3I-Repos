...
Imports Common
Imports System.Data
Partial Class WCC_frmWccPOSiteList
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack = False Then
            objdl.fillDDL(ddlPO, "WCCPODetails", False, Constants._DDL_Default_Select)
            bindData()
        End If
    End Sub
    Sub bindData()
        'grdPOrawdata.Columns(3).Visible = True
        dt = objUtil.ExeQueryDT("Exec uspWccPODetailsList '" & ddlPO.SelectedValue & "','" & ddlSelect.SelectedValue & "','" & txtSearch.Text.Replace("'", "''") & "'," & hdnDisp.Value & ",'" & hdnSort.Value & "'", "PoDetails")
        'dt = objbo.uspWccPODetailsList(ddlPO.SelectedValue, ddlSelect.SelectedValue, txtSearch.Text.Replace("'", "''"), hdnDisp.Value)
