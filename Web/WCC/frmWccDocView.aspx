<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmWccDocView.aspx.vb" Inherits="WCC_frmWccDocView" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
  <title>Wcc Doc View</title>
        ...
        <table cellpadding="1" cellspacing="1" width="100%">
            ...
            <tr id="lblsrcname" runat="Server">
                ...
                <td colspan="2">
                    ...
                    <asp:Button ID="Button1" runat="server" Text="Track" CssClass="goButtonStyle" Width="56px" />
                </td>
            </tr>
        </table>
                    ...
                    <asp:GridView ID="grdDocuments" runat="server" AllowPaging="True" AllowSorting="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="DocName" HeaderText="Document" />
                                ...
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkDownload1" runat="server" OnClick="Download"><%# DataBinder.Eval(Container.DataItem,"DocName") %></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>--%>
