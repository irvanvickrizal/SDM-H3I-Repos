...
Imports System.Data
Imports System.IO
Partial Class WCC_frmWccDocView
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack = False Then
            objDL.fillDDL(ddlPO1, "WCCPODetails", True, Constants._DDL_Default_Select)
        End If
    ...
    Sub binddata()
        ...
        dt = objBo.uspWccSiteDocList(stval(0), ddlPO1.SelectedItem.Text, hdnSort.Value, scope(1))
    ...
    Protected Sub grdDocuments_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdDocuments.RowDataBound
        ...
        End Select
        If e.Row.RowType = DataControlRowType.DataRow Then
            Dim url As String = "frmWccViewDocument.aspx?id=" & e.Row.Cells(9).Text
            ...
            Dim scope() As String = ddlSite.SelectedItem.Text.Split("-")
            url2 = "frmWccViewLog.aspx?id=" & e.Row.Cells(1).Text & "&sid=" & stval(0) & "-" & scope(1)
            e.Row.Cells(8).Text = "<a href='#' onclick=""window.showModalDialog('" & url2 & "','mywindow','status=yes,menubar=no,center=yes,scrollbars=yes,resizable=yes,width:1000px')"">" & "ViewLog" & "</a>"
        End If
    End Sub
    ...
    Protected Sub ddlPO1_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlPO1.SelectedIndexChanged
        ...
        If ddlPO1.SelectedIndex > 0 Then
            ...
            '            ddldt = objBo.uspWccDDLPOSiteNoByUser1(ddlPO1.SelectedItem.Value, lvlcode, area, region, zone, site, Session("User_Id"))
            ddldt = objdb.ExeQueryDT("exec uspWccDDLPOSiteNoByUser1 '" & ddlPO1.SelectedItem.Value & "','" & lvlcode & "','" & area & "','" & region & "','" & zone & "','" & site & "','" & Session("User_Id") & "'", "xyz")
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        Dim stval() As String = ddlSite.SelectedValue.Split("-")
        Dim scope() As String = ddlSite.SelectedItem.Text.Split("-")
        dt = objBo.uspWccSiteDocListInfo(ddlPO1.SelectedItem.Value, stval(0))
    ...
    Public Sub Download(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim fpath As String = ConfigurationManager.AppSettings("WCCpath") & strPath
        If strPath <> "" Then
            If File.Exists(fpath) Then
                DownlaodFile(fpath, True)
            Else
                'ScriptManager.RegisterStartupScript(Page, GetType(UpdatePanel), "Script", "alert('No File Exists With This Site No " & fpath & "');", True)
