...
Imports Common
Imports System.Data
Partial Class WCC_frmWccCODScope
    ...
    End Sub
    Sub binddata()
        dt = objbo.uspWccCODScopeLD(, hdnSort.Value)
        grdScope.DataSource = dt
        grdScope.PageSize = Session("Page_size")
        grdScope.DataBind()
    End Sub
    Sub Binddetails()
        dt = objbo.uspWccCODScopeLD(Request.QueryString("id"))
    ...
    Protected Sub btnCanel_ServerClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCanel.ServerClick
        Response.Redirect("frmWccCODScope.aspx")
    End Sub
    ...
    Protected Sub btnDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        BOcommon.result(objbo.uspWccDelete("WccCODScope", "Scope_ID", Request.QueryString("id")), True, "frmWccCODScope.aspx", " ", Constants._DELETE)
    End Sub
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If Request.QueryString("id") Is Nothing Then
            BOcommon.result(objbo.uspWccCODScopeIU(objET), True, "frmWccCODScope.aspx", txtScope.Value, Constants._INSERT)
        Else
            objET.Scope_ID = Request.QueryString("id")
            BOcommon.result(objbo.uspWccCODScopeIU(objET), True, "frmWccCODScope.aspx", txtScope.Value, Constants._UPDATE)
        End If
    End Sub
End Class
