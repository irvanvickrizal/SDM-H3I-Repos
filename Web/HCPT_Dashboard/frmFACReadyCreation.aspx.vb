...
Partial Class HCPT_Dashboard_frmFACReadyCreation
...
#Region "Custom Methods"
    Private Sub BindData()
        dtDocs = objutil.ExeQueryDT("exec HCPT_uspFAC_GetReadyCreation " & CommonSite.UserId & ", " & ConfigurationManager.AppSettings("BAUTID"), "dt")
        If dtDocs.Rows.Count > 0 Then
            GvRFTReport.DataSource = dtDocs
            GvRFTReport.DataBind()
        Else
            GvRFTReport.DataSource = Nothing
            GvRFTReport.DataBind()
        End If
    End Sub
#End Region
