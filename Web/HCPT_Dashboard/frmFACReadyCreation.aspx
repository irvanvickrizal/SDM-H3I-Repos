<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmFACReadyCreation.aspx.vb" Inherits="HCPT_Dashboard_frmFACReadyCreation" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>FAC Ready Creation</title>
    <style type="text/css">
        .HeaderReport {
    ...
    <form id="form1" runat="server">
        <div style="width: 99%; height: 450px">
            <div class="HeaderReport">
                <table width="100%">
                    <tr>
                        <td style="width: 80%">FAC Acceptance Ready Creation
                        </td>
            ...
            <div>
                <asp:GridView ID="GvRFTReport" runat="server" AllowPaging="true" EmptyDataText="No FAC Ready Creation"
                    ...
                    <Columns>
						...
						<asp:BoundField DataField="PACDate" HeaderText="PAC Done"  DataFormatString="{0:dd-MMM-yyyy}"
                            ConvertEmptyStringToNull="true" HtmlEncode="false" />
                        <asp:BoundField DataField="Remarks" HeaderText="Remarks" ConvertEmptyStringToNull="true" NullDisplayText="New FAC" />
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <a href='../BAUT/frmTI_FAC.aspx?id=<%#Eval("SW_Id") %>&wpid=<%#Eval("workpackageid") %>&from=RC' style="text-decoration: none; border-style: none;">
