<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmCACReadyCreation.aspx.vb" Inherits="HCPT_Dashboard_frmCACReadyCreation" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>CAC Ready Creation</title>
    <style type="text/css">
        .HeaderReport {
    ...
    <form id="form1" runat="server">
        <div style="width: 99%; height: 450px">
            <div class="HeaderReport">
                <table width="100%">
                    <tr>
                        <td style="width: 80%">CAC Acceptance Ready Creation
                        </td>
            ...
            <div>
                <asp:GridView ID="GvCACReport" runat="server" AllowPaging="true" EmptyDataText="No CAC Ready Creation"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Remarks" HeaderText="Remarks" ConvertEmptyStringToNull="true" NullDisplayText="New CAC" />
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <a href='../BAUT/frmTI_CAC.aspx?id=<%#Eval("SW_Id") %>&wpid=<%#Eval("workpackageid") %>&from=RC' style="text-decoration: none; border-style: none;">
