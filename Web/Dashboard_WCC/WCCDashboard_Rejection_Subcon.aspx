<%@ Page Language="VB" AutoEventWireup="false" CodeFile="WCCDashboard_Rejection_Subcon.aspx.vb" EnableEventValidation="false"
    Inherits="Dashboard_WCC_WCCDashboard_Rejection_Subcon" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>WCC Rejection</title>
            ...
            <asp:GridView ID="GvWCCList" runat="server" AutoGenerateColumns="false" CellPadding="2"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="LMBY" HeaderText="Initiator Name" HeaderStyle-CssClass="gridHeader_2"
                        ItemStyle-BorderColor="GrayText" ItemStyle-BorderStyle="solid" ItemStyle-BorderWidth="2px" />
                    <asp:BoundField DataField="RejectionDate" HeaderText="RejectionDate" HtmlEncode="false"
                        DataFormatString="{0:dd-MMM-yyyy HH:mm:ss}" ConvertEmptyStringToNull="true" HeaderStyle-CssClass="gridHeader_2"
                        ItemStyle-BorderColor="GrayText" ItemStyle-BorderStyle="solid" ItemStyle-BorderWidth="2px" />
                    <asp:BoundField DataField="RejectionUser" HeaderText="Rejection User" HeaderStyle-CssClass="gridHeader_2"
                        ItemStyle-BorderColor="GrayText" ItemStyle-BorderStyle="solid" ItemStyle-BorderWidth="2px" />
                    <asp:BoundField DataField="RemarksofRejection" HeaderText="Remarks" HeaderStyle-CssClass="gridHeader_2"
                        ItemStyle-BorderColor="GrayText" ItemStyle-BorderStyle="solid" ItemStyle-BorderWidth="2px" />
                    ...
                    <asp:TemplateField HeaderStyle-CssClass="gridHeader_2" ItemStyle-BorderStyle="solid"
                        ...
                        <ItemTemplate>
                            ...
                            <a id="viewlog" runat="server" class="fancyboxViewLog fancybox.iframe" href="#"><span
                                class="fontLink">View Log</span></a>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
