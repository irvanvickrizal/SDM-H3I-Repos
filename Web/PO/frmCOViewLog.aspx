<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmCOViewLog.aspx.vb" Inherits="PO_frmCOViewLog" %>
    ...
    <div>
            <table cellpadding="1" border="0" cellspacing="1" width="100%">
                ...
                <tr class="lblText">
                    ...
                    <td colspan="2" id="tddocname" runat="server">
                    </td>
                            ...
                            <asp:GridView ID="gvViewLog" runat="server" BackColor="White" CssClass="GridOddRows"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField ItemStyle-HorizontalAlign="Left" HeaderText="Role" DataField="SignTitle"
                                        ItemStyle-BorderWidth="1" />
                                    <asp:BoundField ItemStyle-HorizontalAlign="Center" HeaderText="Start Date Time" DataField="EventStartTime" DataFormatString="{0:dd-MMM-yyyy}" 
                                        ItemStyle-BorderWidth="1" />
                                    <asp:BoundField ItemStyle-HorizontalAlign="Center" HeaderText="End Date Time" DataField="EventEndTime" DataFormatString="{0:dd-MMM-yyyy}"
                                        ItemStyle-BorderWidth="1" />
