<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmTreeDocUpload2.aspx.vb"
    Inherits="frmTreeDocUpload2" %>
            ...
            <table>
                <tr>
                    <td style="height: 17px">
                        <asp:FileUpload ID="fileUpload" runat="server" EnableTheming="True" Width="456px" /><asp:Button
                            ID="btnupload" runat="server" Text="Upload" CssClass="buttonStyle" />
                        (Max 2 MB)
                        <br />
                        <br />
