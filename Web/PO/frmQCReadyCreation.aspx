<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmQCReadyCreation.aspx.vb"
    Inherits="PO_frmQCReadyCreation" %>
    ...
    <form id="form1" runat="server">
        <div style="width: 99%; height: 450px">
            <div class="HeaderReport">
                <table width="100%">
                    <tr>
                        <td style="width: 80%">KPI Acceptance Ready Creation
                        </td>
            ...
            <div>
                <asp:GridView ID="GvQCReport" runat="server" AllowPaging="true" EmptyDataText="No QC Ready Creation"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Remarks" HeaderText="Remarks" ConvertEmptyStringToNull="true" NullDisplayText="New KPI" />
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <a href='../BAUT/frmTI_QC.aspx?id=<%#Eval("SW_Id") %>&wpid=<%#Eval("workpackageid") %>&from=RC' style="text-decoration: none; border-style: none;">
                                    <img src="../Images/doce.gif" alt="KPI Online" id="pdfIcon" height="18" width="18"
