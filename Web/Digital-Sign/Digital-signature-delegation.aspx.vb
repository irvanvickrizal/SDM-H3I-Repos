...
Partial Class Digital_Sign_Digital_signature_delegation
...
#End Region
        ...
        If j > 0 Then
            Try
                ...
                If (strResult = Constants._DigitalSign_Result) Then
                    ...
                    strsql = "Exec [uspDocApproved_OnBehalf] " & Convert.ToInt32(Request.QueryString("id")) & "," & CommonSite.UserId() & ",'" & CommonSite.UserName() & "'," & CommonSite.RollId() & "," & ConfigurationManager.AppSettings("BAUTID") & "," & ConfigurationManager.AppSettings("BASTID") & "," & ConfigurationManager.AppSettings("BAST2ID") & " "
    ...
    Protected Sub btnreview_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnreview.Click
        ...
        If docid = ConfigurationManager.AppSettings("ATP") Then
            i = objutil.ExeQueryScalar("Exec [uspDocApprovedATP_onBehalf] " & Convert.ToInt32(Request.QueryString("id")) & "," & CommonSite.UserId() & ",'" & CommonSite.UserName() & "'," & CommonSite.RollId() & "," & ConfigurationManager.AppSettings("BAUTID") & "," & ConfigurationManager.AppSettings("BASTID") & "," & ConfigurationManager.AppSettings("BAST2ID") & "," & Request.QueryString("wpid"))
        Else
            objutil.ExeQuery("Exec [checkXYCoordinate]")
            i = objutil.ExeQueryScalar("Exec [uspDocApproved_onBehalf] " & Convert.ToInt32(Request.QueryString("id")) & "," & CommonSite.UserId() & ",'" & CommonSite.UserName() & "'," & CommonSite.RollId() & "," & ConfigurationManager.AppSettings("BAUTID") & "," & ConfigurationManager.AppSettings("BASTID") & "," & ConfigurationManager.AppSettings("BAST2ID") & "")
        End If
