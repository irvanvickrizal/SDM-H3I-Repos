<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Digital-signature-delegation.aspx.vb"
    Inherits="Digital_Sign_Digital_signature_delegation" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
            ...
            function WindowsCloseApprover(){
                ...
                window.opener.location.href = '../dashboard/frmDocApproved.aspx?id=' + siteno + '&wpid=' + wpid + '&TId=0' + '&uid=' + uid;
            ...
            function WindowsCloseReviewer(){
                ...
                var wpid = getQueryVariable('wpid');
                var uid = getQueryVariable('uid');
                window.opener.location.href = '../dashboard/frmDocApproved_Delegation.aspx?id=' + siteno + '&wpid=' + wpid + '&TId=0' + '&uid=' + uid;
                if (window.opener.progressWindow) {
                    window.opener.progressWindow.close();
                }
                window.close();
            ...
            function WindowATPOnSiteClose()
            {
                ...
                var siteno = getQueryVariable('siteno');
                var wpid = getQueryVariable('wpid');
                window.opener.location.href = '../dashboard/frmDocApproved_Delegation.aspx?id=' + siteno + '&wpid=' + wpid + '&TId=0&doctype=atp';
                if (window.opener.progressWindow) {
                    window.opener.progressWindow.close();
                }
                window.close();
                    ...
                    <table cellpadding="0" cellspacing="0" style="margin-left: 0px; width: 100%;">
                        <tr>
                            ...
                            <td align="right" valign="top" style="width: 20%">
                                <img src="http://nsndemo.nsnebast.com:1300/Images/logo_tsel.png" alt="logotsel" />
                            </td>
                        </tr>
                    </table>
                    <table cellpadding="0" cellspacing="0" style="margin-left: 0px; width: 100%;">
                    ...
                    <td style="width: 972px" id="dgrow" runat="server">
                        <div style="text-align: center; margin-right: 5px;">
                            <div style="border-style: solid; border-color: Gray; border-width: 1px; margin-left: 2px;
                                margin-right: 2px; width: 350px; text-align: left;">
                                <div style="font-family: Verdana; font-size: 12px; font-weight: bold; background-color: #c3c3c3;
                                    padding: 3px; margin-bottom: 20px; text-align: center;">
