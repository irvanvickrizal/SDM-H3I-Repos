<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CO-Digital-signature.aspx.vb"
    Inherits="Digital_Sign_CO_Digital_signature" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Document Approval/Review</title>
    ...
    <script language="javascript" type="text/javascript">
            ...
            function WindowsCloseCRApprover(){
                ...
                window.opener.location.href = '../dashboard/frmDocCRApproved.aspx?wpid=' + wpid + '&TId=0&doctype=crol';
            ...
            function WindowRejectCloseCR(){
                alert('Rejected document Sucessfully.');
                var siteno = getQueryVariable('siteno');
                var wpid = getQueryVariable('wpid');
    ...
    <form id="form1" runat="server">
        ...
        <asp:MultiView ID="MvCorePanel" runat="server">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ControlStyle-Width="180px">
                                            <ItemTemplate>
                                                ...
                                                <a href="#" onclick="window.open('../po/frmCRViewLog.aspx?id=<%# DataBinder.Eval(Container.DataItem,"DocRegId") %>&wpid=<%# DataBinder.Eval(Container.DataItem,"PackageId") %>&subdocid=<%# DataBinder.Eval(Container.DataItem,"docid") %>&logtype=summary','','Width=800,height=500');">
                                                    <asp:Label ID="LblViewLog" runat="server" Text="ViewLog"></asp:Label> </a>
                                            </ItemTemplate>
                                            <ItemStyle Width="15%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField>
            ...
            <asp:View ID="VwMessagePanel" runat="server">
                <asp:Label ID="LblWarningMessage" runat="server" Text="Some Error Occurs while retrieving Data, Please Try Again!"
                    ForeColor="red" CssClass="lblText"></asp:Label>
            </asp:View>
        </asp:MultiView>
    </form>
</body>
