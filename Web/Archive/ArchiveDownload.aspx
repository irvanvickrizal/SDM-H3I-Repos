<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ArchiveDownload.aspx.vb" Inherits="Archive_ArchiveDownload" %>
    ...
    <div>
        ...
        <tr>
                    <td class="pageTitle" colspan="3">
                        Single Site Documents DownLoad</td>
                </tr>   
        <tr>
       ...
       <tr id="rowURL" runat="server" visible="false">
        ...
        <td></td>
            ...
            <td><asp:Button ID="btnArchive" runat="server" Text="Download"   CssClass="buttonStyle"/> </td>
