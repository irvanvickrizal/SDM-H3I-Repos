<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fb_WCCOnTaskPending_Subcon.aspx.vb"
    Inherits="fancybox_Form_fb_WCCOnTaskPending_Subcon" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>WCC On Task Pending</title>
    <style type="text/css">
        .gridHeader_2
        {
	        font-family:Verdana;
