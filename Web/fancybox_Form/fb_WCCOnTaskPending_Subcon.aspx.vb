Imports System.IO
Partial Class fancybox_Form_fb_WCCOnTaskPending_Subcon
...
#Region "Custom Methods"
    Private Sub BindData(ByVal userid As Integer)
        GvWCCList.DataSource = controller.WCCGetUserLocation_Subcon(userid)
        GvWCCList.DataBind()
    End Sub
    Private Sub ExportToExcel(ByVal gv As GridView)
        If (gv.Rows.Count() > 0) Then
            Dim tw As New StringWriter()
            Dim strFilename As String = "WCCOnTaskPending_" + DateTime.Now.ToShortDateString + ".xls"
