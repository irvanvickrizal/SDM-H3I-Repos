<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fb_SOACHistoricalRejectionLog.aspx.vb"
    Inherits="fancybox_Form_SOAC_fb_SOACHistoricalRejectionLog" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Historical Rejection Log</title>
    <style type="text/css">
        .ltrLabel
        {
            font-family: verdana;
            ...
            <div style="height: 500px;">
                ...
                <div style="margin-top: 10px;">
                    <asp:GridView ID="GvSOACLog" runat="server" AutoGenerateColumns="false" EmptyDataText="No record found"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Document" ItemStyle-BorderColor="Gray" HeaderStyle-BorderColor="Gray">
                                <ItemTemplate>
                                    <asp:Label ID="LblDocname" runat="server" Text='<%#Eval("DocInfo.DocName") %>'
                            ...
                            <asp:BoundField DataField="lmdt" HeaderText="Rejection Date" HtmlEncode="false" DataFormatString="{0:dd-MMM-yyyy HH:mm:ss}"
                                ConvertEmptyStringToNull="true" ItemStyle-BorderColor="Gray" HeaderStyle-BorderColor="Gray" />
                            <asp:BoundField DataField="Remarks" HeaderText="Remarks" ItemStyle-BorderColor="Gray"
                                HeaderStyle-BorderColor="Gray" />
                            <asp:BoundField DataField="Category" HeaderText="Category" ItemStyle-BorderColor="Gray"
                                HeaderStyle-BorderColor="Gray" />
                        </Columns>
                    </asp:GridView>
                </div>
