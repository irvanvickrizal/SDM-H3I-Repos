<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmDashboardLatest.aspx.vb" Inherits="frmDashboard" %>
            ...
            function popSitesDetails(id)
               {
                if (id == 4)
                {
                window.open('DashBoard/DashboardpopupBastNew.aspx?id=' + id, 'welcome', 'width=900,height=700,menubar=no,status=no,location=no,toolbar=no,scrollbars=yes,resizable=yes');
                }
                else
                {
                window.open('DashBoard/EBastDoneDetailsnew.aspx?id=' + id, 'welcome', 'width=900,height=700,menubar=no,status=no,location=no,toolbar=no,scrollbars=yes,resizable=yes');

                }
               }
           function popSitesDetailsBAUT(id)
           {
                if (id == 4)
                {
                window.open('DashBoard/DashboardpopupBautNew.aspx?id=' + id, 'welcome', 'width=900,height=700,menubar=no,status=no,location=no,toolbar=no,scrollbars=yes,resizable=yes');
                }
                else
                {
                window.open('DashBoard/EBautDoneDetailsnew.aspx?id=' + id, 'welcome', 'width=900,height=700,menubar=no,status=no,location=no,toolbar=no,scrollbars=yes,resizable=yes');
