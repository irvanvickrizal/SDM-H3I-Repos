...
Imports Entities
Imports System.Data
Partial Class newRPT_frmdashboardC
        ...
        For Each dRowsStatus As DataRow In dtTask.Rows
            ...
            If dRowsStatus.Item("CountUsrType") > 0 Then
                ...
                ElseIf "Reviewer" = dRowsStatus.Item("usrtype") Then
                    iMainCellSiteName.InnerHtml = "<a href='DashBoard/frmDocApproved.aspx?id=" & dRowsStatus.Item("TSK_ID") & "'>Pending for Review ( " & dRowsStatus.Item("CountUsrType") & " ) </a>"
        ...
        For Each dRowsStatus As DataRow In dtAgenda.Rows
            ...
            ElseIf dRowsStatus.Item("usrtype").ToString().ToLower() = "ld" Then
                If (CommonSite.UserId().ToString <> "1") Then
                    ...
                    End If
                End If
            ElseIf dRowsStatus.Item("usrtype").ToString().ToLower() = "ns" Then 'for new site from EPM

                If dRowsStatus.Item("CountUsrType") > 0 Then
                    iMainCellSiteName.InnerHtml = "<a href=PO/frmPOfromEPMList.aspx>New Sites Created ( " & dRowsStatus.Item("CountUsrType") & " ) </a>"
                End If
            Else
                If dRowsStatus.Item("CountUsrType") > 0 Then
