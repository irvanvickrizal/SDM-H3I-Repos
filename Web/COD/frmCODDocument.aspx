<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmCODDocument.aspx.vb"
    Inherits="frmCODDocument" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table id="tblSection" runat="server" border="0" cellpadding="0" cellspacing="1"
                ...
                <tr>
                    <td class="lblTitle">
                        Document Type<span style="font-family:Verdana; font-size:7pt; font-weight:bold;"></span>
                    </td>
                    <td style="width: 1%">
                        :
                    </td>
            ...
            <asp:GridView ID="grdSection" runat="server" CellPadding="1" AllowPaging="True" AllowSorting="True"
                ...
                <Columns>
                    ...
                    <asp:HyperLinkField DataTextField="DOCName" DataNavigateUrlFields="DOC_ID" DataNavigateUrlFormatString="frmCODDocument.aspx?id={0}&amp;Mode=E"
                    ...
                    <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <a id="popup" href='frmCODDocumentUserAuthorized.aspx?id=<%#Eval("DOC_ID") %>' title='<%#Eval("DOCName") %>' style="text-decoration:none; border:none;">
                                <img src="../Images/document_forbidden.png" id="iconAuth" alt="authIcon" width="20" height="20" style="text-decoration:none;  border:none;" />
                            </a>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
