<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmCODCustomerList.aspx.vb" Inherits="COD_frmCODCustomerList" %>
...
<head runat="server">
  ...
  <script language="javascript" type="text/javascript" >
   function SUBCON(id)
            {
                window.open('frmCODCustomerSiteDetailsView.aspx?id='+id,'welcome','width=400,height=300,menubar=no,status=no,location=no,toolbar=no,scrollbars=yes');
...
<body>
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
      <tr class="pageTitle">
        <td colspan="2"  id="tdTitle" runat="server">Customer Supervisor</td><td align="right"class="pageTitleSub">List</td>
      </tr>
      <tr style="height: 5">
          <td colspan="3">
          </td>
