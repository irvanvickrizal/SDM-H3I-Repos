<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmCODScope.aspx.vb" Inherits="COD_frmCODScope" %>
    ...
    <div>
        ...
        <asp:GridView ID="grdScope" runat="server" CellSpacing="0" CellPadding="1" AllowPaging="True"
            ...
            <Columns>
                ...
                <asp:HyperLinkField DataTextField="Scope" DataNavigateUrlFields="Scope_ID" DataNavigateUrlFormatString="frmCODScope.aspx?id={0}"
