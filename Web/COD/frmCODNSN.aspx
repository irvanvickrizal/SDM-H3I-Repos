<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmCODNSN.aspx.vb" Inherits="COD_frmNSN" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>NSN Supervisor</title>
  ...
  <script language="javascript" type="text/javascript">
        ...
        window.onload = function()
        {
            ...
            TotalChkBx = parseInt('<%= grdNSN.Rows.Count %>');
        ...
        function HeaderClick(CheckBox)
        {
            ...
            var TargetBaseControl = document.getElementById('<%= grdNSN.ClientID %>');
        ...
        function viewUser()
          {
            var aa;
            aa = window.showModalDialog('../USR/frmNSNSupList.aspx?SelMode=true','','width=400,height=300,menubar=no,status=no,location=no,toolbar=no,scrollbars=yes');        
      ...
      <script language="javascript"  type="text/javascript" >
            function NSNCON(id)
            {
                window.open('frmCODNSNSiteDetailsView.aspx?id='+id,'welcome','width=400,height=300,menubar=no,status=no,location=no,toolbar=no,scrollbars=yes');
...
<body>
    ...
    <table id="tblSite" runat="server" border="0" cellpadding="1" cellspacing="0" width="100%">
      <tr>
        <td align="left" class="pageTitle" colspan="2">NSN Supervisor</td><td align="right" id="rowadd" runat="server" class="pageTitleSub">Create</td>
      </tr>
      <tr style="height: 5">
        <td colspan="3">
        </td>
    ...
    <asp:GridView ID="grdNSN" runat="server" AllowPaging="True" AllowSorting="True" Width="100%"
      ...
      <asp:TemplateField HeaderText=" Total ">
        ...
        <asp:TemplateField HeaderText="Select">
            <ItemTemplate>
                ...
                <asp:HiddenField ID="hfUserID" runat="server" Value='<%#Eval("Site_ID")%>' />
            </ItemTemplate>
        ...
        <%--<asp:HyperLinkField DataTextField="Site_No" DataNavigateUrlFields="Site_ID" DataNavigateUrlFormatString="frmCODSubCon.aspx?id={0}&amp;Mode=E"
          HeaderText="Site ID" SortExpression="Site_No">
            <ItemStyle Width="10%" />
        </asp:HyperLinkField>--%>
        <asp:TemplateField HeaderText="Site No" SortExpression="Site_No">
            <ItemTemplate>
                <a href="#" onclick="NSNCON('<%# DataBinder.Eval(Container.DataItem,"Site_ID") %>')"> <%#DataBinder.Eval(Container.DataItem, "Site_No")%>
                </a>
            </ItemTemplate>
        </asp:TemplateField>
