<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmCODSubCon.aspx.vb" Inherits="COD_frmCODSubCon" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        window.onload = function()
        {
            ...
            TotalChkBx = parseInt('<%= grdSubCon.Rows.Count %>');
        ...
        function HeaderClick(CheckBox)
        {
            ...
            var TargetBaseControl = document.getElementById('<%= grdSubCon.ClientID %>');
        ...
        function ChildClick(CheckBox, HCheckBox)
        {
         ...
         function viewUser()
          {
            var aa;
            aa = window.showModalDialog('../USR/frmCODSubConList.aspx?SelMode=true','','width=400,height=300,menubar=no,status=no,location=no,toolbar=no,scrollbars=yes');        
...
<body>
    <form id="frmCODSiteSetup" runat="server">
        <div>
            <table id="tblSite" runat="server" border="0" cellpadding="1" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a id="A1" runat="server" href="#" onclick="viewUser();" class="ASmall">Select Originator</a>
                    </td>
                </tr>
                <tr style="height: 5">
            ...
            <asp:GridView ID="grdSubCon" runat="server" AllowPaging="True" AllowSorting="True"
          ...
          HeaderText="Site ID" SortExpression="Site_No">
            <ItemStyle Width="10%" />
                    ...
                    <asp:TemplateField HeaderText="Site No" SortExpression="Site_No">
                        <ItemTemplate>
                            <a href="#" onclick="SUBCON('<%# DataBinder.Eval(Container.DataItem,"Site_ID") %>')">
                    ...
                    <asp:BoundField DataField="SName" HeaderText="Originator" SortExpression="SName"
                        Visible="false">
                        <ItemStyle Width="15%" />
                    </asp:BoundField>
                </Columns>
