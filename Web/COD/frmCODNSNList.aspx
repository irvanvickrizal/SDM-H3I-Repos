<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmCODNSNList.aspx.vb" Inherits="COD_frmNSNList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>NSN Supervisor Lst</title>
...
<body>
    ...
    <div>
      ...
      <tr class="pageTitle">
        <td colspan="2"  id="tdTitle" runat="server">NSN Supervisor</td><td align="right"class="pageTitleSub">List</td>
      </tr>
       <tr style="height: 5">
          <td colspan="3">
          </td>
      ...
      <tr>
        ...
        <td>
          <asp:DropDownList ID="ddlSelect" runat="server" CssClass="selectFieldStyle">
            ...
            <asp:ListItem Value="C.[Name]">Supervisor</asp:ListItem>
          </asp:DropDownList>
    ...
    <asp:GridView ID="grdNSN" runat="server" AllowPaging="True" AllowSorting="True" Width="100%"
      ...
      <asp:TemplateField HeaderText=" Total ">
        ...
        <asp:BoundField DataField="Name" HeaderText="Supervisor" SortExpression="Name" >
            <ItemStyle Width="15%" />
        </asp:BoundField>
      </Columns>
    </asp:GridView>
